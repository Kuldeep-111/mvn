            ...
            <div className="overlay-content">
              <div className="inner-overlay">
                <div className="video-area d-none d-md-block">
                  <img
                    src={CONFIG.IMAGE_URL + "renders/elevation/2.webp"}
                    ...
                    <div className="inner-menu">
                              ...
                              {window.innerWidth > 768 ? (
                                <>
                                  ...
                                  <li>
                                    <NavLink
                                      to={
                                        import.meta.env.VITE_APP_URL + "career"
                                      }
                                      onClick={() => toggleMenu("close")}
                                    >
                                      Career
                          ...
                          <div className="right bottom d-md-none">
                            <ul>
                              ...
                              <li>
                                <NavLink
                                  to={
                                    import.meta.env.VITE_APP_URL + "contact-us"
                                  }
                                  onClick={() => toggleMenu("close")}
                                >
                                  Contact Us
                      ...
                      <div className="top-area">
                        ...
                        <ul className="sub_menu">
                          <li>
                            <label htmlFor="school" className=" d-block w-100">
                              Social Media
                            </label>
                            <ul className="social_links ">
                              <li>
                                ...
                                >
                                  <img
                                    src={`${
                                      CONFIG.IMAGE_URL + "social/fb.png"
                                    }`}
                                    alt="mvn-fb-icon"
                                  />
                                </Link>
                              ...
                              <li>
                                ...
                                >
                                  <img
                                    src={`${
                                      CONFIG.IMAGE_URL + "social/instagram.png"
                                    }`}
                                    alt="mvn-insta-icon"
                                  />
                                </Link>
                              ...
                              <li>
                                ...
                                >
                                  <img
                                    src={`${
                                      CONFIG.IMAGE_URL + "social/linkedin.png"
                                    }`}
                              ...
                              <li>
                                ...
                                >
                                  <img
                                    src={`${
                                      CONFIG.IMAGE_URL + "social/youtube.png"
                                    }`}
