...
const BangaoreMasterBedroom = ({ data, onLoadComplete }) => {
  ...
  const { title, desc, mobilePath,desktopPath } = data.masterBedroom;

  let totalFramesMobile ;// Total frames for mobile

  isMobile ? 
  totalFramesMobile = 225
  : totalFramesMobile = 162;
  ...
  // const path = "assets/videos/living-room/desktop/";
...
export default BangaoreMasterBedroom;
