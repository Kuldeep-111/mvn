...
const MicroPageBangalore1 = React.lazy(()=>import("./frontend/pages/MicroPageBangalore1.jsx"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "mvn-athens-faridabad1",
        element: (<MicroPageAthensFaridabad data={AthensData}/>
        ),
      },
      {
